        ...
        <nav className="border-gray-200 xl:w-3/4 w-full self-center flex justify-center">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between p-4 w-full">
                <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="/pylamp_logo.png" className="sm:h-20 h-12" alt="Flowbite Logo" />
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 place-items-center">
                        <li>
