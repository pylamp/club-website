  ...
  return (
    <div className="flex justify-center p-5">
      <div className="xl:w-3/4 w-full flex flex-col lg:flex-row justify-center lg:justify-between">
        ...
        <div className="lg:w-2/3 self-center p-5">
          ...
          <p className="md:text-xl lg:w-2/3 text-lg font-normal text-left">{desc}</p>
        </div>
        {imgPosition === "right" && (
          <div className="md:w-1/3 self-center flex flex-row-reverse">
            <img
              src={imgSrc}
              alt={imgAlt}
              className="lg:h-56 sm:h-50 h-40 rounded-full"
